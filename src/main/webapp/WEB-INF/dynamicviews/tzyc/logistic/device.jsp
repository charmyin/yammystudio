...
<body>
	<table id="dg" title="物流巡检设备信息" class="easyui-datagrid"
		url="logistic/all" toolbar="#toolbar" pagination="true"
		rownumbers="true" fitColumns="true" singleSelect="true">
		<thead>
			<tr>

				<th field="typeName" width="50">物流巡检设备检查种类</th>
				<th field="name" width="50">物流巡检设备名称</th>
				<th field="model" width="50">物流巡检设备型号</th>
				<th field="code" width="50">物流巡检设备编码</th>
	...
	function length(){
    	...
    	$.post('room/getlist',{exportfield:exportfield,exportheaders:exportheaders,title:title},function(result){
