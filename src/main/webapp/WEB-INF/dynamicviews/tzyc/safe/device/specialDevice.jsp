...
<body>
    <table id="dg" title="特殊设备信息管理" class="easyui-datagrid" 
        ...
        <thead>
            <tr>
                ...
                <th field="productionBatch" width="50">生产批号</th>
                <th field="registrationCode" width="50">注册代码</th>
    ...
    <div id="dlg" class="easyui-dialog" style="width:400px;height:530px;padding:10px 20px"
      ...
      <!--   <div class="ftitle">用户信息</div> -->
        <form id="fm" method="post" novalidate>
            <div class="fitem">
                ...
                <input name="typeId" id="typeId" value="2" type="hidden"> 
            </div>
            <div class="fitem">
                <label>设备名称:</label>
            ...
            <div class="fitem">
                <label>生产批号:</label>
                <input name="productionBatch"  class="easyui-validatebox" data-options="required:true,validType:['length[0,60]']">
            </div>
            <div class="fitem">
                <label>注册代码:</label>
                <input name="registrationCode"  class="easyui-validatebox" data-options="required:true,validType:['length[0,60]']">
            </div>
            <div class="fitem">
                <label>位置:</label>
            ...
            <div class="fitem">
                <label>用途:</label>
                <input name="application" class="easyui-validatebox" data-options="required:true,validType:['length[0,60]']">
            </div>
            <div class="fitem">
                <label>启用日期:</label>
            ...
            <div class="fitem">
                <label>设备状态:</label>
                <select class="easyui-combobox" id="easyComboboxId" data-options=" panelHeight:'auto'," name="equipStatus" style="width:100px;">
