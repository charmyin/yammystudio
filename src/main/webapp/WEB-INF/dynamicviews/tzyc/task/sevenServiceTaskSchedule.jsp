...
<body>
    <table id="dg" title="7S调度管理" class="easyui-datagrid" 
    		data-options="method:'GET'"
            url="/tzyc/taskSchedule/allTaskScheduleWithPagination?taskTableName=TB_7S_INSPECT_TASK"
        ...
        <thead>
            <tr>
                ...
                <th field="onceTime" width="50">即时执行时间</th>
...
<!--                 <th field="taskTableName" width="50">对应插入任务表名</th>
                ...
                <th field="objectName" width="50" >检查点名称</th>
    ...
    <div id="dlg" class="easyui-dialog" style="width:530px;height:430px;padding:10px 20px"
        ...
        <form id="fm" method="post" novalidate>
            <div class="fitem">
                ...
                <input type="hidden" value="TB_7S_INSPECT_TASK" name="taskTableName" id="taskTableName" />
            </div>
            <div class="fitem">
                <label>计划调度分类:</label>
	...
	<div id="standard-dlg" class="easyui-dialog" data-options="closed:'true',buttons:'#standard-dlg-buttons', modal:true, maximizable:true" style="width:1100px;">
		...
		<div id="cc" class="easyui-layout" style="width:100%;height:400px;" data-options="fit:true">
		    ...
		    <div data-options="region:'center'" style="padding:5px;background:#eee;">
		        <table id="standardGrid" title="7S检查标准" class="easyui-datagrid" 
		            url="7sInspectStandard/findAllWithOptions"
		            toolbar="#standardToolbar" pagination="true" 
		            rownumbers="true" fitColumns="true" fit="true" singleSelect="true">
			        <thead>
			            <tr>
			                <th data-options="field:'id', hidden:true">id</th>
			                <th field="typeName" width="50">7S管理评价分类</th>
			                <th field="itemName" width="50">7S管理评价项目</th>
  ...
  //删除临时任务
    function deleteInstantTask(taskId, id){
  	  $.ajax({ 
           url: "taskSchedule/deleteInstantTaskBy_7s?taskId="+taskId+"&id="+id, 
          // dataType: "text/plain", 
    ...
    var deleteInstantTask2 = ");'>删除</a>";
        ...
        function editObject(){
            ...
            if (row){
            	if(row.taskType == 0){
            		$.messager.show({
    					title:'提示',
    					msg:"<p style='color:orange; font-weight:bold; text-align:center;'>即时任务不可修改</p>",
    					timeout : 2000,
    					showType:'slide',
    					style:{
    						right:'',
                    ...
                    $('#fm').form('load',row);
                    selectFrequencyComboBox(row.taskType+'');
        ...
        function saveObject(){
        	...
        	$("#taskTableName").val("TB_7S_INSPECT_TASK");
        ...
        $(function(){
    	    ...
    	    $('#evaluateType').combobox({
				...
				onSelect:function(record){
					$('#evaluateItem').combobox('reload', '7sEvaluateItem/getOne?typeId='+record.id);
        	...
        	$("#object_btn").click(function(){
        		 //初始化commonDevice
            	 var deviceDataGrid = $('#object1Id-dg').datagrid({
       			    url:'/tzyc/7sInspectPoint/all',
       			    method:'POST', 
       			    title:"7S检查点管理",
       			    closed:false,
       			    pagination:true,
       			    ...
       			    columns:[[
       			        ...
       			        {field:'code',title:'检查点编码',width:100},
       			        {field:'pointName',title:'检查点名称',width:100},
       			        {field:'departId',title:'部门名称',width:100, hidden:true},
        	...
        	var selectedStandardDataGrid = $('#selectedStandardsDataGrid').datagrid({
			    url:'7sInspectStandard/byStandardIds',
			    method:'POST', 
			    title:"已选择标准",
			    closed:false,
			    ...
			    columns:[[
			        ...
			        {field:'standardDesc',title:'评价描述',width:100}
			    ]]
			});
